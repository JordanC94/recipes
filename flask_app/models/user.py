...
class User:
    ...
    @classmethod
    def get_user_with_recipe(cls, data:dict):
        query = "SELECT * FROM users LEFT JOIN recipe ON users.id = recipe.user_id WHERE users.id = %(id)s;"
